...
Image* image01 = Image::createImage((std::string(ASSETS_DIR)+"/textures/me.png").c_str());
Image* image02 = Image::createImage((std::string(ASSETS_DIR) + "/textures/goku.jpg").c_str());
void render() {
	sgl->clear();
